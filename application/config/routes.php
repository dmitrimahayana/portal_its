...
$route['page_404'] 						        = 'page/page_404';
//$route['kalender/(:any)'] 						= 'page/kalender/$1';
$route['agenda/(:any)']							= 'page/archive_agenda/$1';
$route['pengumuman/(:any)']						= 'page/archive_pengumuman/$1';
...
/* routing add data  */
$route['beranda/manageNew/add/data/(:any)']		= 'backend/addDataNew/$1';
/* routing delete data  */
$route['beranda/manageNew/delete/(:any)/(:any)']			= 'backend/deleteDataNew/$1/$2';
/* routing edit data  */
$route['beranda/manageNew/edit/data/(:any)']               = 'backend/editDataNew/$1';

$route['beranda/manageNew/add/(:any)']			= 'backend/addDemitNew/$1';
$route['beranda/manageNew/edit/(:any)/(:any)']			= 'backend/editDemitNew/$1/$2';
$route['beranda/manageNew/(:any)']					= 'backend/manageDemitNew/$1';

//$route['layanan_liputan/(:any)']					= 'page/layanan_liputan/$1';
