...
<table>
	<tr>
		<td>Nama (*)</td>
		<td>
			<input type="text" id="name" class="input size290 required" maxlength="50" placeholder="Nama Video Eureka" value="<?php echo $fill->name; ?>" disabled="disabled" />
		</td>
	</tr>
	<tr>
		<td>Judul (*)</td>
		<td>
			<input type="text" name="title" id="title" class="input size290 required" maxlength="150" placeholder="Judul Video Eureka" value="<?php echo $fill->title; ?>" />
		</td>
	</tr>
	<tr>
		<td>ID Youtube (*)(**)</td>
		<td>
			<input type="text" name="youtube_id" id="youtube_id" class="input size290 required" maxlength="50" placeholder="ID Youtube" value="<?php echo $fill->youtube_id; ?>" />
		</td>
	</tr>
	<!--
	<tr>
		<td>Link (*)</td>
		<td>
			<input type="text" name="name" id="name" class="input size290 required" maxlength="30" placeholder="Link Eureka" value="<?php echo $fill->link; ?>"/>
		</td>
	</tr>
	-->
	<tr>
