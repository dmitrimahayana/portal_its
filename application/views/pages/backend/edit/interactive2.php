...
<table>
	...
	<tr>
		...
		<td>
			<input type="text" name="name_id" id="name_id" class="input size290" maxlength="30" placeholder="Teks Bahasa Indonesia" <?php if($fill_id!=null):?>value="<?php echo $fill_id->text;?>"<?php endif;?> />
		</td>
	</tr>
	<tr>
		<td>Tampilan Inggris</td>
		<td>
			<input type="text" name="name_en" id="name_en" class="input size290" maxlength="30" placeholder="Teks Bahasa Inggris" <?php if($fill_en!=null):?>value="<?php echo $fill_en->text;?>"<?php endif;?> />
		</td>
	</tr>
	<tr>
		<td>Tanggal Mulai</td>
