...
<table>
	...
	<tr>
        ...
        <tr>
		<td>Tentang (*)</td>
		<td><textarea style="margin-left: 30px;" name="aboutID" id="aboutID" class="input size300" minlength="100"  value="<?php echo $row->about; ?>" /><?php echo $row->about; ?></textarea></td>
	</tr>
        <tr>
		<td>About (**)</td>
		<td><textarea style="margin-left: 30px;" name="aboutEN" id="aboutEN" class="input size300" minlength="100" value="<?php echo $row2->about; ?>" /><?php echo $row2->about; ?></textarea></td>
	</tr>
        <tr>
	...
	<tr>
        ...
        <tr>
		<td>Latitude</td>
		<td><input type="text" name="latitude" id="latitude" class="input size290" maxlength="150" value="<?php echo $row->latitude; ?>" /></td>
	</tr>
        <tr>
		<td>Longitude</td>
		<td><input type="text" name="longitude" id="longitude" class="input size290" maxlength="150" value="<?php echo $row->longitude; ?>" /></td>
	</tr>
	<tr>
