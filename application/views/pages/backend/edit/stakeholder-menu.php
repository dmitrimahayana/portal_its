...
<table>
	<tr>
		<td>Kode (*)</td>
		<td>
			<input type="text" id="name" class="input size290 required" maxlength="30" placeholder="Kode Menu Stakeholder" value="<?php echo $fill->name;?>" disabled="disabled" />
		</td>
	</tr>
	<tr>
		<td>Nama (*)</td>
		<td><input type="text" name="title" id="title" class="input size290" maxlength="100" placeholder="Nama Menu Stakeholder" value="<?php echo $fill->title;?>"/></td>
	</tr>
	<tr>
		<td>Urutan (*)</td>
		<td><input type="text" name="order" id="order" class="input size290" maxlength="5" placeholder="Urutan" value="9999" value="<?php echo $fill->order;?>"/></td>
	</tr>
	<tr>
		<td>Online</td>
	...
	<tr>
		<td>Link (*)</td>
		<td>
			<input type="text" name="link" id="link" class="input size290" maxlength="150" placeholder="Link Menu Stakeholder" value="<?php echo $fill->link;?>" />
		</td>
	</tr>
	<tr>
		<td></td>
	...
	$("form").validate(
		{
			...
			rules: {
				...
				link: { required: true, maxlength: 150 }
			}
		}
	);
});
