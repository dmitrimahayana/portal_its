				<tr>
					...
					<th class="table-header-options line-left">Singkatan</th>
					...
					<th class="table-header-options line-left size290">Dean</th>
				...
				<tr>
					...
					<td>
						<a href="<?php echo base_url(); ?>beranda/manageNew/edit/<?php echo $info;?>/<?php echo $row->idFak;?>" title="Edit" class="icon-edit info-tooltip"></a>
						<a href="#" id="delete<?php echo $row->idFak; ?>" title="Delete" class="icon-delete info-tooltip" onclick="confirm_delete('<?php echo $row->idFak;?>','<?php echo $row->namaFakultas;?>')"></a>
					</td>
				</tr>
				<?php
						$count++;
