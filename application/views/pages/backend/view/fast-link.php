				...
				{
					var answer = confirm("Apakah Anda ingin menghapus link cepat \""+nama+"\" ?")
					if (answer==true)
					{
				...
				<tr>
					...
					<td>
						<a href="<?php echo base_url(); ?>beranda/edit/<?php echo $info;?>/<?php echo $row->id_fast_link;?>" title="Edit" class="icon-edit info-tooltip"></a>
						<a href="#" id="delete<?php echo $row->id_fast_link; ?>" title="Delete" class="icon-delete info-tooltip" onclick="confirm_delete('<?php echo $row->id_fast_link;?>','<?php echo $row->url;?>')"></a>
					</td>
				</tr>
				<?php
						$count++;
