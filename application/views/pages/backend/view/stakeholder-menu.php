				<tr>
					...
					<th class="table-header-options line-left">Alias</th>
				...
				<tr>
					...
					<td>
						<a href="<?php echo base_url(); ?>beranda/edit/<?php echo $info;?>/<?php echo $row->id_stakeholder_menu;?>" title="Edit" class="icon-edit info-tooltip"></a>
						<a href="#" id="delete<?php echo $row->id_stakeholder_menu; ?>" title="Delete" class="icon-delete info-tooltip" onclick="confirm_delete('<?php echo $row->id_stakeholder_menu;?>','<?php echo $row->name;?>')"></a>
					</td>
				</tr>
				<?php
						$count++;
