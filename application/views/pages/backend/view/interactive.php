				...
				{
					var answer = confirm("Apakah Anda ingin menghapus menu interaktif \""+nama+"\" ?")
					if (answer==true)
					{
				...
				<tr>
					...
					<td>
						<a href="<?php echo base_url(); ?>beranda/edit/<?php echo $info;?>/<?php echo $row->id_interactive;?>" title="Edit" class="icon-edit info-tooltip"></a>
						<a href="#" id="delete<?php echo $row->id_interactive; ?>" title="Delete" class="icon-delete info-tooltip" onclick="confirm_delete('<?php echo $row->id_interactive;?>','<?php echo $row->name;?>')"></a>
					</td>
				</tr>
				<?php
						$count++;
