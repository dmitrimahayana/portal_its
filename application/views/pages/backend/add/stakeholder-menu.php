<table>
	<tr>
		<td>Kode (*)</td>
		<td>
			<input type="text" name="name" id="name" class="input size290 required" maxlength="30" placeholder="Kode Menu Stakeholder" />
		</td>
	</tr>
	<tr>
		<td>Nama (*)</td>
		<td><input type="text" name="title" id="title" class="input size290" maxlength="100" placeholder="Nama Menu Stakeholder"/></td>
	</tr>
	<tr>
		<td>Urutan (*)</td>
	...
	<tr>
		<td>Link (*)</td>
		<td>
			<input type="text" name="link" id="link" class="input size290" maxlength="150" placeholder="Link Menu Stakeholder" value="#" />
		</td>
	</tr>
	<tr>
		<td></td>
	...
	<tr>
		<td>Icon</td>
		<td>
			<?php echo form_dropdown('icon', $options_media, '', 'id="icon" class="input size300"'); ?>
		</td>
	</tr>
	<tr>
		<td></td>
