...
<table>
	<tr>
		<td>Kode (*)</td>
		<td>
			<input type="text" name="slug" id="slug" class="input size290 required" maxlength="30" placeholder="Kode Grup Pengguna" />
		</td>
		<td></td>
	</tr>
	<tr>
		<td>Nama (*)</td>
		<td><input type="text" name="group_name" id="group_name" class="input size290" maxlength="50" placeholder="Nama Grup Pengguna" /></td>
		<td></td>
	</tr>
	<tr>
		<td>Deskripsi</td>
		<td><input type="text" name="description" id="description" class="input size290" maxlength="50" placeholder="Deskripsi Grup Pengguna" /></td>
		<td></td>
	</tr>
	<tr>
		<td>Level (**) </td>
		<td><input type="text" name="level" id="level" class="input size290" maxlength="50" placeholder="Tingkat Grup Pengguna" /></td>
		<td></td>
	</tr>
	<tr>
		<td>Hak Akses</td>
