...
<table>
	<tr>
		<td>Nama (*)</td>
		<td>
			<input type="text" name="name" id="name" class="input size290 required" maxlength="30" placeholder="Nama Stakeholder" />
		</td>
	</tr>
	<tr>
		<td>Nama Indonesia (*)</td>
		<td><input type="text" name="name_id" id="name_id" class="input size290" maxlength="50" placeholder="Nama Stakeholder dalam Bahasa Indonesia" /></td>
	</tr>
	<tr>
		<td>Nama Inggris </td>
		<td><input type="text" name="name_en" id="name_en" class="input size290" maxlength="50" placeholder="Nama Stakeholder dalam Bahasa Inggris" /></td>
	</tr>
	<tr>
