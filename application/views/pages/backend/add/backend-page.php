...
<table>
	<tr>
		<td>Nama (*)</td>
		<td>
			<input type="text" name="name" id="name" class="input size290 required" maxlength="30" placeholder="Kode Halaman Backend" />
		</td>
	</tr>
	<tr>
		<td>Tampilan nama (*)</td>
		<td><input type="text" name="display_name" id="display_name" class="input size290" maxlength="50" placeholder="Nama Tampilan Halaman Backend" /></td>
	</tr>
	<tr>
		<td>Induk</td>
