...
<table>
	<tr>
		...
		<td><input type="text" name="name_id" id="name_id" class="input size290" maxlength="30" placeholder="Nama Menu Cepat Indonesia"/></td>
	</tr>
	<tr>
		<td>Nama Inggris</td>
		<td><input type="text" name="name_en" id="name_en" class="input size290" maxlength="30" placeholder="Nama Menu Cepat Inggris"/></td>
	</tr>
	<tr>
		<td>URL (*)</td>
		<td><input type="text" name="url" id="url" class="input size290" placeholder="URL Menu Cepat" value="#" /></td>
	</tr>
	<tr>
		<td>Urutan (*)</td>
