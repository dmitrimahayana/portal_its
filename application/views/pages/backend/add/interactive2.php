...
<table>
	...
	<tr>
		...
		<td>
			<input type="text" name="name_id" id="name_id" class="input size290" maxlength="30" placeholder="Teks Bahasa Indonesia" />
		</td>
	</tr>
	<tr>
		<td>Tampilan Inggris</td>
		<td>
			<input type="text" name="name_en" id="name_en" class="input size290" maxlength="30" placeholder="Teks Bahasa Inggris" />
		</td>
	</tr>
	<tr>
		<td>Tanggal Mulai</td>
