		...
		<ul id="menu" class="margin-top-10">
			...
			?>
                        <li>
                            ...
                            <ul>
                                <li>
                                    <a href="<?php echo base_url(); ?>beranda/manageNew/view_fakultas">Fakultas</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>beranda/manageNew/view_jurusan">Jurusan</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>beranda/manageNew/footer_jurusan">Footer Jurusan</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a><b>MANAJEMEN LAIN</b></a>
                            <ul>
                                <li>
                                    <a href="<?php echo base_url(); ?>beranda/manageNew/doodle">Doodle Event</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>beranda/manageNew/pengumuman">Pengumuman</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url(); ?>beranda/manageNew/its_point">ITS Point</a>
                                </li>
                            </ul>
                        </li>
