	...
	<div class="container" id="main">
		...
		<!--end banner-->
                <div id="nav-top" style="margin-right: 30px;">
                   ...
                   <div class="right" id="searchbox-container" style="margin-top: -120px;width: 190px;height: 115px;background: url(<?php echo base_url(); ?>/files/<?php echo $doodle;?>) no-repeat 5px 0px;">
                        <form style="margin-top:115px;background: red;z-index: 100;" action="<?php echo base_url(); ?>pencarian/<?php echo $lang ?>" method="get" name="realm">
                ...
                <div style="z-index: 0px;position: relative; top: -80px;width: 660px;margin-left: 265px;color: blue;font-size: 12pt;float: left;">
                    <?php if($this->uri->segment(1)=="index" || $this->uri->segment(1)==""): ?>
                    <!--sekilas info-->
                    <div id="sekilas-info">
                        <?php
		...
		<div class="grid_2 margin-left-0 borderless" style="margin-top: -10px;">
			...
			?>
			<h2 style="color:gray;margin-left: 50px;margin-top:30px;" class="">Pengumuman</h2>
                    <div id="video_slide" style="overflow-y: scroll;width: 180px;height: 200px;margin-left: 50px;">
                        <table>
                        <?php 
                        if(isset($pengumuman)): 
                            foreach ($pengumuman as $row):
                                if($lang=='id'){ ?>
                                    <tr>
                                        <td><a class="ex1" style="" href="<?php if($row->jenis=='file') echo base_url().$row->url; else if($row->jenis=='article') echo $row->url.'/'.$lang; else echo $row->url; ?>" target="_blank"><?php echo $row->indonesia; ?></a></td>
					</tr>
					<tr>
						<td><a style="color:grey;"><?php echo $row->date; ?></a></td>                                    
					</tr>
                                <?php }
                                else { ?>
                                    <tr>
                                        <td><a class="ex1" style="" href="<?php if($row->jenis=='file') echo base_url().$row->url; else if($row->jenis=='article') echo $row->url.'/'.$lang; else echo $row->url; ?>" target="_blank"><?php echo $row->inggris; ?></a></td>
                                    </tr>
					<tr>
						<td><a style="color:grey;"><?php echo $row->date; ?></a></td>   
					</tr>
